...
export class PaisCiudadController {
  ...
  async find(
    ...
    return this.paisRepository.ciudads(id).find(filter);
  }
  ...
  async create(
    ...
    return this.paisRepository.ciudads(id).create(ciudad);
  }
  ...
  async patch(
    ...
    return this.paisRepository.ciudads(id).patch(ciudad, where);
  }
  ...
  async delete(
    ...
    return this.paisRepository.ciudads(id).delete(where);
  }
}
